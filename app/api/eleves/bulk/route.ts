...
export async function GET() {
  const template = {
    ...
    exemple: [
      { nom: 'DUPONT', prenom: 'Jean', dateNaissance: '2010-05-15', lieuNaissance: 'Paris', sexe: 'M', classeId: '507f1f77bcf86cd799439011' },
      { nom: 'MARTIN', prenom: 'Marie', dateNaissance: '2010-08-20', lieuNaissance: 'Lyon', sexe: 'F', classeId: '507f1f77bcf86cd799439011' },
    ],
    instructions: [
